...
export default function GenerateQuizAI() {
  ...
  const isBlocked = !quizInfo?.titre || !quizInfo?.theme;
    ...
    return (
      <div className={styles.blockedPage}>
        <div className={styles.blockedCard}>
          ...
          <p>
            Pour utiliser la génération IA, vous devez d’abord créer les
            informations principales du quiz : titre, thème, classe, difficulté
            et durée.
          </p>
  ...
  return (
    <div className={styles.page}>
      ...
      <section className={styles.summaryCard}>
        ...
        <div>
          <span>Thème</span>
          <strong>{quizInfo.theme}</strong>
        </div>

        <div>
          <span>Classe</span>
          <strong>{quizInfo.classe || "Non définie"}</strong>
        </div>
